...
\fancyfoot[C]{\transparent{0.5}cv last updated on \today}
...
\personalinfo{
  ...
  \mylocation{\#723, 1st A Cross Rd. Vijaya Bank Layout, Bengaluru, Karnataka}
  \phone{+918086249788}
 }
...
\end{itemize}
\divider
\cvemployer{Center for Development Studies, Thiruvananthapuram}{Remote}
\cvrole{Data Analysis Project}{September - October 2020}
\begin{itemize}
